...
export async function updateCourierHelper (services: IService,
  ...
  const isSuccessfull = await services.usersService.updateUser(id, role, rowChangeData, EUserRole.Courier)
