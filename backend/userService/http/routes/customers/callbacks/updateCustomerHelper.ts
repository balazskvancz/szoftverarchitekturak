...
export async function updateCustomerHelper (services: IService,
  ...
  const isSuccessfull = await services.usersService.updateUser(id, role, rowChangeData, EUserRole.Customer)
